...
namespace GMBEditor
{
    ...
    public class DataAttributeCategory_Window : GMBEditorWindow<Data_AttributeCategory> 
    {
        ...
        {
            return new GMBWindowMenuItem(this, "menu_attribute_categories", "Attribute Categories", "Attributes");
        }
