...
namespace GMBEditor
{
    public class DataOccasion_Window : GMBEditorWindow<Data_Occasion> //Need to change Implementation data Type
    {
        ...
        {
            return new GMBWindowMenuItem(this, "menu_occasion_items", "Occasions List", "Occasion");
        }
    }
}